...
class TestStaticPropsPreservation:
    """Tests for preserving static props across hot reload."""

    def test_static_props_preserved_after_reload(self, temp_dir):
...
class TestDynamicPropsPreservation:
    """Tests for preserving dynamic props (bound with :prop) across hot reload."""

    def test_dynamic_props_preserved_after_reload(self, temp_dir):
...
class TestEventHandlersPreservation:
    """Tests for preserving event handlers across hot reload."""

    def test_event_handlers_preserved_after_reload(self, temp_dir):
...
class TestStaticAttributesPreservation:
    """Tests for preserving static attributes on elements across hot reload."""

    def test_static_attributes_preserved_on_child_elements(self, temp_dir):
        """
...
class TestDynamicAttributesPreservation:
    """Tests for preserving dynamic attributes on elements across hot reload."""

    def test_dynamic_attributes_preserved_on_elements(self, temp_dir):
        """
...
class TestRefsPreservation:
    """Tests for preserving refs across hot reload."""

    def test_static_ref_available_after_reload(self, temp_dir):
...
class TestSlotContentPreservation:
    """Tests for preserving slot content configuration across hot reload."""

    def test_slot_content_props_preserved(self, temp_dir):
...
class TestMixedAttributesPreservation:
    """Tests for preserving mixed static and dynamic attributes."""

    def test_mixed_props_preserved(self, temp_dir):
...
class TestNestedComponentPreservation:
    """Tests for preserving deeply nested component configurations."""

    def test_deeply_nested_props_preserved(self, temp_dir):
...
class TestVForPreservation:
    """Tests for preserving configuration in v-for contexts."""

    def test_vfor_item_props_preserved(self, temp_dir):
...
class TestDynamicComponentPreservation:
    """Tests for preserving configuration with :is dynamic components."""

    def test_dynamic_component_props_preserved(self, temp_dir):
...
class TestVIfConditionPreservation:
    """Tests for preserving v-if conditions across hot reload."""

    def test_vif_component_props_preserved(self, temp_dir):
        ...
        # Dynamic prop should be preserved (since _binds isn't cleared)
        widget = container["children"][0]
        assert widget["children"][0]["attrs"]["text"] == "Msg: Hello (v2)"


class TestComponentRefPreservation:
    """Tests for preserving component refs across hot reload."""

    def test_component_ref_reregistered_after_reload(self, temp_dir):
...
class TestVBindSpreadPreservation:
    """Tests for preserving v-bind spread operator across hot reload.
    ...
    def test_vbind_spread_props_preserved(self, temp_dir):
...
class TestMultipleEventHandlersPreservation:
    """Tests for preserving multiple event handlers across hot reload."""

    def test_multiple_events_preserved(self, temp_dir):
