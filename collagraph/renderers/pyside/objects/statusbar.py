...
@PySideRenderer.register_insert(QtWidgets.QStatusBar)
...
@PySideRenderer.register_remove(QtWidgets.QStatusBar)
def remove(self, el):
    self.removeWidget(el)
    el.setParent(None)


@PySideRenderer.register_set_attr(QtWidgets.QStatusBar)
